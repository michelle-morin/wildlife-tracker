...
Basic console application to track wildlife in a zoo.
...
_Confirm that you have navigated to the wildlife-tracker directory (e.g., by entering the command_ ``pwd`` _in Terminal)._
